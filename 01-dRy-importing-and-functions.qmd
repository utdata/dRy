...
3. Sometimes you do something that creates a warning in R, but you don't always care. `#| warning: false` hides those warnings. We will talk about this more later.
...
# comment out the col_types line and the comma to see what happens       #<6>
